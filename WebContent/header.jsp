      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="container/index.htm">Home
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="container/index.htm">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="form/login.htm">Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="form/create-account.htm">Create Account</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://www.facebook.com/anhtuan.nguyentran.904">Contact</a>
          </li>
        </ul>
      </div>
    </div>

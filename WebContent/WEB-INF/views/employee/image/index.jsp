  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
		<c:forEach var="u" items="${images}">
           <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="list/${u.id}.htm">
              	
              <img class="card-img-top" src="images/${u.fileName }" alt="">
              
              </a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="list/${u.id}.htm">${u.description}</a>
                </h4>
                
                <h4 class="card-title">
                  <a href="image/edit/${u.id}.htm">EDIT</a>
                  <a href="image/delete/${u.id}.htm">DELETE</a>
